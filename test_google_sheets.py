#!/usr/bin/env python3
"""
Script de teste para verificar a integração com Google Sheets
"""
...
def test_config():
    ...
    if not os.path.exists("google_sheets_config.py"):
        print("❌ google_sheets_config.py não encontrado")
        return False
    
    if not os.path.exists("google_sheets_manager.py"):
        print("❌ google_sheets_manager.py não encontrado")
        return False
...
def main():
    ...
    print("✅ Você pode executar o experimento: python the_chamber.py")
